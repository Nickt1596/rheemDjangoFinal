...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', config('SERVER', default='127.0.0.1'), 'lit-river-07905.herokuapp.com',
                 'www.freightprostracking.com']
...
EMAIL_HOST_USER = '4a62f948c506dea7'
EMAIL_HOST_PASSWORD = 'NBYocA6sG1tDx4eQminLjAxj'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
